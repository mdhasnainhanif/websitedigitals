...
export const appStoreOptimizationServicesData = [
  {
    ...
    image: "/assets/images/app-store-optimization-services/explore-our-full-suite-of-aso-services/1.svg",
    isActive: true,
  },
  {
    id: 2,
    ...
    image: "/assets/images/app-store-optimization-services/explore-our-full-suite-of-aso-services/2.svg",
    isActive: false,
  },
  {
    id: 3,
    ...
    image: "/assets/images/app-store-optimization-services/explore-our-full-suite-of-aso-services/3.svg",
    isActive: false,
  },
  {
    id: 4,
    ...
    image: "/assets/images/app-store-optimization-services/explore-our-full-suite-of-aso-services/4.svg",
    isActive: false,
  },
  {
    id: 5,
    ...
    image: "/assets/images/app-store-optimization-services/explore-our-full-suite-of-aso-services/5.svg",
    isActive: false,
  },
  {
    id: 6,
    ...
    image: "/assets/images/app-store-optimization-services/explore-our-full-suite-of-aso-services/6.svg",
    isActive: false,
  },
];
  ...
  items: [
    {
      ...
      icon: "/assets/images/app-store-optimization-services/why-our-aso-company-is-trusted-by-app-owners/1.svg",
      paragraphs: [
    ...
    },
    {
      ...
      icon: "/assets/images/app-store-optimization-services/why-our-aso-company-is-trusted-by-app-owners/2.svg",
      paragraphs: [
    ...
    },
    {
      ...
      icon: "/assets/images/app-store-optimization-services/why-our-aso-company-is-trusted-by-app-owners/3.svg",
      paragraphs: [
    ...
    },
    {
      ...
      icon: "/assets/images/app-store-optimization-services/why-our-aso-company-is-trusted-by-app-owners/4.svg",
      paragraphs: [
...
export const appStoreOptimizationImpactCardsData = [
  {
    ...
    image: "/assets/images/app-store-optimization-services/why-every-app-needs-a-strong-aso-strategy/1.svg",
  },
  {
    id: 2,
    ...
    isHighlighted: true,
    col: "col-12 col-md-4 col-lg-4",
    image: "/assets/images/app-store-optimization-services/why-every-app-needs-a-strong-aso-strategy/2.svg",
  },
  {
    id: 3,
    ...
    isHighlighted: false,
    col: "col-12 col-md-4 col-lg-4",
    image: "/assets/images/app-store-optimization-services/why-every-app-needs-a-strong-aso-strategy/3.svg",
  },
];
  ...
  steps: [
    {
      ...
      image: "/assets/images/app-store-optimization-services/our-aso-process/1.svg",
      alignment: "right",
    },
    {
      id: 2,
      ...
      image: "/assets/images/app-store-optimization-services/our-aso-process/2.svg",
      alignment: "left",
    },
    {
      id: 3,
      ...
      image: "/assets/images/app-store-optimization-services/our-aso-process/3.svg",
      alignment: "right",
    },
    {
      id: 4,
      ...
      image: "/assets/images/app-store-optimization-services/our-aso-process/4.svg",
      alignment: "left",
    },
  ],
};
...
export const appStoreOptimizationIndustriesCardsData = [
  {
    title: "Gaming",
    description: "We deliver expert app store optimization services for gaming, focusing on category alignment, keyword targeting, and creative sequencing. From optimizing preview frames to genre-specific terms, we help gaming apps attract players, boost installs, and strengthen retention.",
    imgOriginal: `/assets/images/app-store-optimization-services/industries-we-serve/original/1.svg`,
    imgWhite: `/assets/images/app-store-optimization-services/industries-we-serve/hover/1.svg`,
  ...
  },
  {
    title: "Travel Booking",
    description: "Our app store optimization services for travel booking focus on geo-localized keywords, seasonal trends, and creative localization. By aligning listings with peak travel periods and destination searches, we ensure your app reaches more travelers and drives sustained installs.",
    imgOriginal: `/assets/images/app-store-optimization-services/industries-we-serve/original/2.svg`,
    imgWhite: `/assets/images/app-store-optimization-services/industries-we-serve/hover/2.svg`,
  ...
  },
  {
    title: "Food Delivery",
    description: "With app store optimization services for food delivery, we target hyperlocal keywords, cuisine-based search terms, and listing creatives that highlight delivery speed. This approach improves visibility, attracts local users, and boosts organic installs in competitive food app markets.",
    imgOriginal: `/assets/images/app-store-optimization-services/industries-we-serve/original/3.svg`,
    imgWhite: `/assets/images/app-store-optimization-services/industries-we-serve/hover/3.svg`,
  ...
  },
  {
    title: "Fitness",
    description: "We provide tailored app store optimization services for fitness apps, optimizing for subscription-based keywords, workout features, and integrations like Apple Health or Google Fit. Our strategies improve discoverability, drive installs, and retain engaged, active users.",
    imgOriginal: `/assets/images/app-store-optimization-services/industries-we-serve/original/4.svg`,
    imgWhite: `/assets/images/app-store-optimization-services/industries-we-serve/hover/4.svg`,
  ...
  },
  {
    title: "SaaS",
    description: "Our app store optimization services for saas help business apps capture high-intent users through metadata refinement, category optimization, and trial-related keywords. By optimizing creatives and store presence, SaaS apps improve installs and scale across iOS and Android.",
    imgOriginal: `/assets/images/app-store-optimization-services/industries-we-serve/original/5.svg`,
    imgWhite: `/assets/images/app-store-optimization-services/industries-we-serve/hover/5.svg`,
  ...
  },
  {
    title: "Workflow",
    description: "We specialize in app store optimization services for workflow apps by targeting role-based keywords, integration terms, and automation-focused metadata. This ensures better discoverability, stronger conversion rates, and increased installs among professionals and teams seeking productivity solutions.",
    imgOriginal: `/assets/images/app-store-optimization-services/industries-we-serve/original/6.svg`,
    imgWhite: `/assets/images/app-store-optimization-services/industries-we-serve/hover/6.svg`,
...
// Technologies Data (PlatformsSpecialize expects "image" or "icon" for the icon display)
export const appStoreOptimizationTechnologiesData = [
  {
    ...
    width: 71,
    height: 71,
    image: "/assets/images/app-store-optimization-services/technologies-we-use/1.svg",
    imgOriginal: "/assets/images/app-store-optimization-services/technologies-we-use/1.svg",
    imgWhite: "/assets/images/app-store-optimization-services/technologies-we-use/1.svg",
  ...
  },
  {
    ...
    image: "/assets/images/app-store-optimization-services/technologies-we-use/2.svg",
    imgOriginal: "/assets/images/app-store-optimization-services/technologies-we-use/2.svg",
    imgWhite: "/assets/images/app-store-optimization-services/technologies-we-use/2.svg",
    width: 71,
    height: 71,
  ...
  },
  {
    ...
    image: "/assets/images/app-store-optimization-services/technologies-we-use/3.svg",
    imgOriginal: "/assets/images/app-store-optimization-services/technologies-we-use/3.svg",
    imgWhite: "/assets/images/app-store-optimization-services/technologies-we-use/3.svg",
    width: 71,
    height: 71,
  ...
  },
  {
    ...
    image: "/assets/images/app-store-optimization-services/technologies-we-use/4.svg",
    imgOriginal: "/assets/images/app-store-optimization-services/technologies-we-use/4.svg",
    imgWhite: "/assets/images/app-store-optimization-services/technologies-we-use/4.svg",
    width: 71,
    height: 71,
  ...
  },
  {
    ...
    image: "/assets/images/app-store-optimization-services/technologies-we-use/5.svg",
    imgOriginal: "/assets/images/app-store-optimization-services/technologies-we-use/5.svg",
    imgWhite: "/assets/images/app-store-optimization-services/technologies-we-use/5.svg",
    width: 71,
    height: 71,
    alt: "Swift App Store Optimization",
  },
  {
    id: 6,
    title: "Kotlin",
    ...
    image: "/assets/images/app-store-optimization-services/technologies-we-use/6.svg",
    imgOriginal: "/assets/images/app-store-optimization-services/technologies-we-use/6.svg",
    imgWhite: "/assets/images/app-store-optimization-services/technologies-we-use/6.svg",
    width: 71,
    height: 71,
    alt: "Kotlin App Store Optimization",
  },
];
