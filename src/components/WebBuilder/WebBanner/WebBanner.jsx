            ...
            <div className="row">
              ...
              <div className="imgSlideRow tech-track">
                <div className="imgLeftSlider">
                  ...
                  <div className="slideImg">
                    <img src="/assets/images/landingpage/imgslide2.webp" alt="slideImg" />
                  </div>
                  <div className="slideImg">
                    <img src="/assets/images/landingpage/imgslide3.webp" alt="slideImg" />
                  </div>
                  <div className="slideImg">
                    <img src="/assets/images/landingpage/imgslide4.webp" alt="slideImg" />
                  </div>
                  <div className="slideImg">
                    <img src="/assets/images/landingpage/imgslide1.webp" alt="slideImg" />
                  </div>
