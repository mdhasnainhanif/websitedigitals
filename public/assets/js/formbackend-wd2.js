...
jQuery( document ).ready(function() {
    ...
    jQuery("#popupform").on("submit", function (event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: ajaxurl, // Replace with the actual path to your PHP script
            data: getfields + '&action=popup_form',
            success: function (response) {
                ...
                window.location.href = 'https://websitedigitals.com/web-design/thank-you//';
            },
            error: function () {
    ...
    jQuery("#popupformsubmit").on("submit", function (event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: ajaxurl, // Replace with the actual path to your PHP script
            data: getfields + '&action=popupsubmit_form',
            success: function (response) {
    ...
    jQuery("#logostepform").on("submit", function (event) {
        ...
        jQuery.ajax({
            type: "POST",
            url: ajaxurl, // Replace with the actual path to your PHP script
            data: getfields + '&action=logo_step_form',
            success: function (response) {
...
jQuery("#homebrief").on("submit", function (event) {
    ...
    jQuery.ajax({
        type: "POST",
        url: ajaxurl,
        data: getfields + '&action=web_step_form',
        success: function (response) {
           ...
           // console.log("final url:", data.url )
            ...
            window.location.href = 'https://websitedigitals.com/brief/thankyou?brief_id=' + data?.id + '&company_name=' + data?.company_name + '&email=' + email;
        },
        error: function () {
            jQuery('.contactsecnpagealert .alert-danger').fadeIn();
        }
