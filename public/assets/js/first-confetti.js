(function($){
    $(document).ready(function() {
        ...
        var confetti = new confetti.Context('first-confetti');
        confetti.start();
...
(function($){
    $(document).ready(function() {
        ...
        var confetti = new confetti.Context('second-confetti');
        confetti.start();
        $(window).resize(function() {
            confetti.resize();
        });
...
(function($){
    $(document).ready(function() {
        ...
        var confetti = new confetti.Context('popup-confetti-1');
        confetti.start();
        $(window).resize(function() {
            confetti.resize();
        });
...
(function($){
    $(document).ready(function() {
        ...
        var confetti = new confetti.Context('popup-confetti-2');
        confetti.start();
        $(window).resize(function() {
            confetti.resize();
        });
