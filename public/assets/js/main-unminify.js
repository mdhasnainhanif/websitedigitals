            ...
            <div class="webPortfolio-caseStudyDetailArea">
              ...
              <div class="webPortfolio-caseStudyDetail">
                ...
                <div class="view-before-after-div">
                  ...
                  <img src="https://www.websitedigitals.com/frontend/assets/images/arrow-blue.png" width="100%">
                  </a>
                </div>
              </div>
            </div>
...
$('.language-partner').owlCarousel({
    loop: true,
    margin: 20,
    nav: false,
    dots: false,
    autoplay: true,  // Enable autoplay
    autoplayTimeout: 3000,  // Gap between slides (3 seconds)
    autoplaySpeed: 800,  // Speed of transition (800ms)
    autoplayHoverPause: false,
    responsive: {
        0: {
            items: 4  // Show 2 items on mobile
        },
        600: {
            items: 5  // Show 5 items on iPad
        },
        768: {
            items: 7  // Show 7 items on iPad Pro
        },
        1000: {
            items: 8  // Show 8 items on desktop
        }
    }
});
